...
HD_PWD='C:/Users/PikesPlace/Documents/HW5/HW5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISC_CPU_PIPELINE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISC_CPU_PIPELINE.tcl
