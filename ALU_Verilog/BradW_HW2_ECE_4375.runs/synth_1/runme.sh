...
HD_PWD='C:/Users/PikesPlace/Google Drive/TTU/Spring 2020/Microprocessor Arch/BradW_HW2_ECE_4375/BradW_HW2_ECE_4375.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Function_Unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Function_Unit.tcl
